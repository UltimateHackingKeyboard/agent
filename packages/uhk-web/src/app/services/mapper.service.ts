...
export class MapperService {
    ...
    private initScanCodeTextMap(): void {
        ...
        this.basicScanCodeTextMap.set(89, ['Np end', '1']);
        this.basicScanCodeTextMap.set(90, ['Np 2', 'icon-kbd__mod--arrow-down']);
        this.basicScanCodeTextMap.set(91, ['Np pgdn', '3']);
        ...
        this.basicScanCodeTextMap.set(95, ['Np home', '7']);
        this.basicScanCodeTextMap.set(96, ['Np 8', 'icon-kbd__mod--arrow-up']);
        this.basicScanCodeTextMap.set(97, ['Np pgup', '9']);
        this.basicScanCodeTextMap.set(98, ['Np Insert', '0']);
