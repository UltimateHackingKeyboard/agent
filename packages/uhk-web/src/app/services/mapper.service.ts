...
export class MapperService {
    ...
    private initScanCodeTextMap(): void {
        ...
        this.basicScanCodeTextMap.set(92, ['4', 'icon-kbd__mod--arrow-left']);
        this.basicScanCodeTextMap.set(93, ['5']);
        this.basicScanCodeTextMap.set(94, ['6', 'icon-kbd__mod--arrow-right']);
        this.basicScanCodeTextMap.set(95, ['home', '7']);
        this.basicScanCodeTextMap.set(96, ['8', 'icon-kbd__mod--arrow-up']);
