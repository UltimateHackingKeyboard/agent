...
let config1Ts: Serializable<ModuleConfigurations> = new ModuleConfigurations().fromJsObject(config1Js);
...
console.log();
let config2Ts = new ModuleConfigurations().fromBinary(config1Buffer);
console.log('\n');
